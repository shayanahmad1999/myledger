...
class SavingsGoal extends Model
{
    ...
    protected function casts(): array { return ['target_amount'=>'decimal:4','allocated_amount'=>'decimal:4','target_date'=>'date','is_completed'=>'boolean']; }
    public function account(): BelongsTo { return $this->belongsTo(LedgerAccount::class, 'account_id'); }
    public function currency(): BelongsTo { return $this->belongsTo(Currency::class); }
    public function allocations(): HasMany { return $this->hasMany(SavingsAllocation::class); }
